...
//    private Client testClient = new Client("test", "test");
    private Long clientID; // TODO remove hardcoded value when register service is fixed
//    private Model tempModel;
    ...
    public void savePlaylistValidTest() {
        ...
        assertTrue("Playlist should be fecthable", playlistService.getPlaylists(clientID).isEmpty());
        assertTrue("Valid playlist", playlistService.savePlaylist(playlist));
        assertFalse("Playlist should be fecthable", playlistService.getPlaylists(clientID).isEmpty());
